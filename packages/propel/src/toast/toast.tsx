  ...
  return (
    <BaseToast.Root
      ...
      className={cn(
        ...
        "group flex w-[350px] items-center rounded-md border border-subtle bg-surface-1 shadow-lg",
        "absolute right-3 bottom-3 z-[calc(1000-var(--toast-index))]",
        "ease-&lsqb;cubic-bezier(0.22,1,0.36,1)&rsqb; transition-[opacity,transform] duration-300 select-none",
