      ...
      <BaseTooltip.Root delay={openDelay} closeDelay={closeDelay} disabled={disabled}>
        ...
        <BaseTooltip.Portal>
          <BaseTooltip.Positioner
            className={cn(
              "z-50 max-w-xs gap-1 overflow-hidden rounded-md border border-subtle bg-layer-1 px-3 py-1.5 text-xs break-words shadow-md transition-opacity duration-200",
              {
                hidden: isMobile,
              },
              className
