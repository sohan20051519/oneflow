...
// Constants
const OVERLAY_CLASSNAME = cn("fixed inset-0 z-90 bg-black/80 backdrop-blur-xs transition-opacity duration-200");
const BASE_CLASSNAME = "relative text-left bg-surface-1 rounded-lg shadow-lg w-full z-100 border border-subtle";
