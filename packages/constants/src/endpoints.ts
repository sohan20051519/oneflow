...
// one flow website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://oneflow.app";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@oneflow.app";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://oneflow.app/pricing";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://oneflow.app/contact";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://oneflow.app/one";
