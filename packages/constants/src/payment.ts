...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "one flow Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for one flow Cloud",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = "https://oneflow.app/talk-to-sales";
...
export const SUBSCRIPTION_REDIRECTION_URLS: Record<EProductSubscriptionEnum, Record<TBillingFrequency, string>> = {
  ...
  [EProductSubscriptionEnum.PRO]: {
    month: "https://app.oneflow.app/upgrade/pro/self-hosted?plan=month",
    year: "https://app.oneflow.app/upgrade/pro/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.BUSINESS]: {
    month: "https://app.oneflow.app/upgrade/business/self-hosted?plan=month",
    year: "https://app.oneflow.app/upgrade/business/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.ENTERPRISE]: {
    month: TALK_TO_SALES_URL,
    year: TALK_TO_SALES_URL,
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: "https://oneflow.app/pro",
  [EProductSubscriptionEnum.BUSINESS]: "https://oneflow.app/business",
  [EProductSubscriptionEnum.ENTERPRISE]: "https://oneflow.app/business",
};
