...
enum badgeSizeStyling {
  sm = `px-2 py-0.5 font-semibold text-xs rounded-md flex items-center gap-1.5 whitespace-nowrap transition-all justify-center inline`,
  md = `px-2.5 py-0.5 font-semibold text-xs rounded-md flex items-center gap-1.5 whitespace-nowrap transition-all justify-center inline`,
  lg = `px-3 py-1 font-semibold text-xs rounded-md flex items-center gap-1.5 whitespace-nowrap transition-all justify-center inline`,
  xl = `px-3.5 py-1 font-semibold text-xs rounded-md flex items-center gap-1.5 whitespace-nowrap transition-all justify-center inline`,
}
