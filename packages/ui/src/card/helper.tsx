...
const DEFAULT_STYLE = "bg-surface-1 rounded-xl border border-subtle w-full flex flex-col shadow-sm transition-all duration-300";
export const containerStyle: ICardProperties = {
  [ECardVariant.WITHOUT_SHADOW]: "",
  [ECardVariant.WITH_SHADOW]: "hover:shadow-md duration-300",
};
