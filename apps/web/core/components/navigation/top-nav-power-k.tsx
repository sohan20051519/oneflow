...
export const TopNavPowerK = observer(() => {
  ...
  return (
    <div ref={containerRef} className="relative">
      <div
        className={cn("relative z-30 flex w-[220px] sm:w-[280px] md:w-[364px] items-center transition-all duration-300 ease-in-out", {
          "w-[320px] sm:w-[440px] md:w-[554px]": isOpen,
        })}
      >
        <div
          className={cn(
      ...
      <div
        className={cn(
          ...
          {
            "max-h-[80vh] w-[340px] sm:w-[460px] md:w-[574px] opacity-100": isOpen,
