...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout one flow without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          "Write one flow Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync one flow work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom one flow and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: "Get one flow activity in Slack and use / commands in\nSlack to make changes in one flow.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create one flow work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create one flow work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour one flow workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        ...
        description: "Secure your one flow workspace with device-\ndependent two-factor authentication and passkeys. ",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted one flow instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: "Install and deploy your self-hosted one flow to any\nprivate cloud with a single-line command.",
        cloud: {
          free: false,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <a href="https://oneflow.app/talk-to-sales" target="_blank" rel="noopener noreferrer" className="underline">
              can be requested
            </a>
            .
          </>
