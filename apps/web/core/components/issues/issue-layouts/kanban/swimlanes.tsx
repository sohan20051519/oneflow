        ...
        list.map((_list: IGroupByColumn) => {
          ...
          return (
            <div
              ...
              className="flex w-[350px] flex-shrink-0 flex-col border-r border-subtle-1 pr-3.5 mr-3.5 last:border-r-0 last:pr-0 last:mr-0"
            >
              <HeaderGroupByCard
        ...
        list.map((_list: IGroupByColumn, subGroupIndex) => {
          ...
          return (
            <div key={_list.id} className="flex flex-shrink-0 flex-col">
              <div className="sticky top-[50px] z-[3] flex w-full items-center border-y border-subtle-1 bg-layer-1 py-1">
