        ...
        list.map((subList: IGroupByColumn, groupIndex) => {
          ...
          return (
            <div
              ...
              } border-r border-subtle-1 pr-3.5 mr-3.5 last:border-r-0 last:pr-0 last:mr-0`}
            >
              {sub_group_by === null && (
                <div className="sticky top-0 z-[2] w-full flex-shrink-0 bg-surface-2 py-1 border-b border-subtle-1 mb-2">
                  <HeaderGroupByCard
