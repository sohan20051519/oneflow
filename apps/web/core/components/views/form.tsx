...
import { EViewAccess, EIssuesStoreType, EIssueLayoutTypes } from "@plane/types";
...
const DEFAULT_VALUES: Partial<IProjectView> = {
  ...
  display_filters: { ...getComputedDisplayFilters(), group_by: "state", layout: EIssueLayoutTypes.KANBAN },
};
