...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the core building block of OneFlow. Tasks, cycles, and milestones align smoothly across projects.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
    ...
    description:
      "Cycles help you and your team to progress faster, similar to sprints in agile development.",
    image: CyclesTour,
    prevStep: "work-items",
    nextStep: "modules",
  },
  {
    ...
    description: "Modules break your big initiatives into focused features and deliverables.",
    image: ModulesTour,
    prevStep: "cycles",
    nextStep: "views",
  },
  {
    ...
    title: "Views",
    description:
      "Create custom filters to display only the work items that matter to you. Save and share views in one click.",
    image: ViewsTour,
    prevStep: "modules",
    nextStep: "pages",
  },
  {
    ...
    description: "Use Pages to capture ideas, specs, and meeting notes directly within your project context.",
    image: PagesTour,
    prevStep: "views",
  },
];
...
export const TourRoot = observer(function TourRoot(props: TOnboardingTourProps) {
  ...
  return (
    <>
      {step === "welcome" ? (
        <div className="w-4/5 overflow-hidden rounded-xl bg-surface-1 md:w-1/2 lg:w-2/5 border border-subtle shadow-xl">
          <div className="h-full overflow-hidden">
            <div className="grid h-48 place-items-center bg-[hsl(352,82%,52%)] text-white">
              <PlaneLockup className="h-9 w-auto text-white" />
            </div>
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold text-lg tracking-tight">
                Welcome to OneFlow, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Streamlined workflow and project execution. Get started by creating your first project.
              </p>
