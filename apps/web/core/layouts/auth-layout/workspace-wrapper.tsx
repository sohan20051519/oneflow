...
export const WorkspaceAuthWrapper = observer(function WorkspaceAuthWrapper(props: IWorkspaceAuthWrapper) {
  ...
  const currentWorkspaceInfo =
    (workspaceSlug && workspaceInfoBySlug(workspaceSlug.toString())) ||
    (currentWorkspace
      ? ({
          id: currentWorkspace.id,
          member: typeof currentWorkspace.owner === "string" ? currentWorkspace.owner : currentWorkspace.owner?.id,
          role: currentWorkspace.role ?? 20,
          workspace: currentWorkspace.id,
          company_role: null,
          created_at: currentWorkspace.created_at,
          created_by: currentWorkspace.created_by,
          updated_at: currentWorkspace.updated_at,
          updated_by: currentWorkspace.updated_by,
        ...
        <div className="relative container mx-auto flex h-full w-full flex-col overflow-hidden overflow-y-auto px-5 py-14 md:px-0">
          ...
          <div className="relative flex h-full w-full flex-grow flex-col items-center justify-center space-y-3">
            <div className="relative flex-shrink-0">
              <img src={WorkSpaceNotAvailable} className="h-[220px] object-contain object-center" alt="one flow logo" />
            </div>
