...
const APP_TITLE = "OneFlow | Streamlined Project & Product Management";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="theme-color" content="#E81B5B" />
        {/* Meta info for PWA */}
        <meta name="application-name" content="OneFlow" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { name: "twitter:image:alt", content: "OneFlow - Modern project management" },
];
