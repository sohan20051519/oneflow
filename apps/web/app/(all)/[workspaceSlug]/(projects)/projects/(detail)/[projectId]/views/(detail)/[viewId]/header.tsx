...
import { DisplayFiltersSelection, FiltersDropdown, LayoutSelection, MobileLayoutSelection } from "@/components/issues/issue-layouts/filters";
      ...
      <Header.RightItem className="items-center">
        ...
        {canUserCreateIssue && (
          ...
          >
            ...
            <span className="hidden xl:inline">Add work item</span>
            <span className="inline xl:hidden">Issue</span>
          </Button>
        )}
