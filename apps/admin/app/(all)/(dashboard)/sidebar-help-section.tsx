...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://docs.oneflow.app/",
    Icon: PageIcon,
  },
  {
    name: "Join our Community",
    href: "https://community.oneflow.app",
    Icon: MessageSquare,
  },
  {
    name: "Report a bug",
    href: "https://github.com/sohan20051519/oneflow/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to one flow" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to one flow"}
          </a>
        </Tooltip>
