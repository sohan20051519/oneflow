...
const APP_TITLE = "one flow Publish | Make your one flow boards public with one-click";
const APP_DESCRIPTION = "one flow Publish is a customer feedback management tool built on top of oneflow.app";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://sites.oneflow.app/" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:site", content: "@oneflowapp" },
];
